...
// Appearance → Desktop: frosting, look (gaps/border/rounding/shadow), opacity.
Item {
  id: root
  ...
  readonly property var menu: ({
    ...
    rows: [
      ...
      { itemId: "desktop.sep.fonts", kind: "separator" },
      { itemId: "desktop.fonts", label: "Fonts", icon: "", kind: "menu" }
    ]
  })
